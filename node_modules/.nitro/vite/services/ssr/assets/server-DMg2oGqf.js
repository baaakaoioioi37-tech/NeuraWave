import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-hNru9bk4.js";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BQM7swsM.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cs21an5U.js"),
		import("./start-g8sz5vyk.js"),
