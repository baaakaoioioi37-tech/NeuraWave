...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-GnNfhQ6k.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "block w-5 h-0.5 bg-foreground mb-1" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "block w-5 h-0.5 bg-foreground mb-1" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "block w-5 h-0.5 bg-foreground" })
					]
				})
			]
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionTitle, {
				...
				children: APPS.map((app) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.article, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `absolute inset-0 -z-10 bg-linear-to-br ${app.tint} opacity-0 group-hover:opacity-100 transition-opacity` }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
							whileHover: {
								scale: [
									1,
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionTitle, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
						...
						className: "w-full rounded-2xl bg-input/50 border border-border px-4 py-3 outline-none focus:border-primary focus:ring-2 focus:ring-primary/30 transition resize-none"
					})] }),
...
function Field({ label, value, onChange, type = "text", placeholder, required, maxLength }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
		...
		required,
		maxLength,
		className: "w-full rounded-2xl bg-input/50 border border-border px-4 py-3 outline-none focus:border-primary focus:ring-2 focus:ring-primary/30 transition"
	})] });
}
